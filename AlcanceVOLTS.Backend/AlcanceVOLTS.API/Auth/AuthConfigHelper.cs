...
namespace AlcanceVOLTS.API.Auth
{
    public static class AuthConfigHelper
    {
        ...
        public static AuthResultDTO GenerateToken(UserDTO user, AppSettings appSettings, IDistributedCache cache, SigningConfigurations signingConfigurations)
        {
            ...
            (
                ...
                new[]
                {
                    ...
                    new Claim(ClaimTypes.Role, user.UserType.GetHashCode().ToString()),
            ...
            (
                result.RefreshToken,
                JsonConvert.SerializeObject(new RefreshTokenData { RefreshToken = result.RefreshToken, Email = user.Login }),
                cacheOptions
            );
